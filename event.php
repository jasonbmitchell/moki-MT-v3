...
<div id="left_arrow">
    <img src="<?php bloginfo('template_url'); ?>/style/images/arrow_L.png" />
</div>
<div id="right_arrow">
    <img src="<?php bloginfo('template_url'); ?>/style/images/arrow_R.png" />
</div>
<div class="get_started_container signup white fixed slider hidden transitions ipad">
    ...
    <div class="block block_one shadow_bot">
        ...
        <div class="content">
            ...
            <div class="hero_text inline topalign" style="padding-top: 95px;">
                ...
                <div class="get_started_container signup white position_element">
                    <div class="get_started_button inline topalign topLeftRadius bottomLeftRadius ipad">Get Started</div>
                    <div class="get_started_arrow inline topalign topRightRadius bottomRightRadius"><div id='arrow_container'> </div></div>
                </div>
            </div>
        </div>
    ...
    <div class="block block_hidden shadow_bot">
        ...
        <div class="content">
            ...
            <div class="hero_text inline topalign" style="margin-top: 50px;">
                <div class="touch_logo light_font" style="padding-top: 69px; font-size: 20px; line-height: 30px; color:lightgrey;">
                    Engage your customers with focused </br>
                    content in iPad and Android tablet kiosks
                </div>
                <div class="taylor_video inline">
                    <div id='taylor_wrapper' class="play_wrapper borderRadiusSmall inline topalign">
                        <div class="triangle-right"></div>
                    </div>
                    <div class="inline topalign midalign" style="padding-left: 10px; padding-top: 3px;">
                        <span class="bold hero_color" style="font-size: 9px;" >WATCH VIDEO:</span><br />
                        <span class="hero_color light_font" style="font-size: 17px;">Taylor Boats</span>
                    </div>`
                </div>

                <div class="get_started_container signup white">
                    <div class="get_started_button inline topalign topLeftRadius bottomLeftRadius ipad">Get Started</div>
                    <div class="get_started_arrow inline topalign topRightRadius bottomRightRadius"><div id='arrow_container'> </div></div>
                </div>
...
<!-- Enter Customers block -->
<div class="block block_eight">
    <div class="content">

        <div class="inline topalign block_text">
            <div class="customers_header bold">
                Customers who love <img src="<?php bloginfo('template_url'); ?>/style/images/heart.png" width="50" height="43" alt=""> MokiTouch
            </div>

        </div>
        <div class="customers inline topalign">
            <table id="Table_01" width="498" height="220" border="0" cellpadding="0" cellspacing="0">
                <tr>
                    <td>
                        <a href="https://vimeo.com/49801224#at=0" target="_blank"><img src="<?php bloginfo('template_url'); ?>/style/images/both_customers_01.png" width="250" height="220" alt=""></a></td>
                    <td>
                        <a href="https://vimeo.com/50547474#at=0" target="_blank"><img src="<?php bloginfo('template_url'); ?>/style/images/both_customers_02.png" width="248" height="220" alt=""></a></td>
                </tr>
            </table>
        </div>
        <div class="clear"></div>
...
<div class="block block_nine">
    <div class="content">

        <div class="left">
            <div class="kiosk"></div>
        </div>
        <div class="touch_pro inline topalign">
            <div class="touch_pro_logo bold" style="padding-top: 62px; font-size: 19px; line-height: 27px; color:#333333">
                Go beyond displaying web content with MokiTouch Pro.
                Enhance your kiosk experience with features like video
                looping and video caching, screensaver, credit card
                swipe, and google analytics.
            </div>
        </div>
        <div class="get_started_container white upgrade_to_pro">
            <a href="http://mokitouch.com/mokitouch-announcement/">
                <div class="get_started_button inline topalign topLeftRadius bottomLeftRadius upgrade_to_pro">UPGRADE TO PRO</div>
                <div class="get_started_arrow inline topalign topRightRadius bottomRightRadius"><div id='arrow_container'> </div></div></a>
        </div>
