...
<?php 
	if (is_category( "solution-center" )) {
?>
...
<?php
	if (is_category( "solution-center" )) {
	$displayposts = new WP_Query(array('category_name' => 'enclosures,featured,restaurant,retail', 'posts_per_page' => 100));
 } else { 
	$displayposts = new WP_Query(array('cat' => $selected_ID, 'posts_per_page' => 100));
 }
...
<div class="appName"><?php the_title(); ?><span class="app-details"> &rarr;<span></div>
<?php
