...
<head>
  ...
  <!--        <script src="<?php bloginfo('template_url'); ?>/js/mobility.js"></script>-->
  <link rel="shortcut icon" href="<?php bloginfo('template_url'); ?>/style/images/favicon.png">
    ...
    <body>
        ...
        <div class="container">
            <div class="header">
                <div class="content">
                    <div class="login gray_background bottomLeftRadius bottomRightRadius right">
                        <span><a href="https://mokimanage.appspot.com/" target="_blank">Login</a></span>
                        <span><a id="signup">Sign Up</a></span>
                    </div>
                    <div class="clear"></div>
                    <div class="nav" style="margin-top: 35px;">
                        <a href="<?php echo home_url(); ?>"><div class="logo left"></div></a>
                        <a href="http://www.mokitouch.com/manage/">
                            <div class="link topLeftRadius topRightRadius right">
                                <div class="manage_link" ></div>
                                <p>App & Device <br /> Management Platform</p>
                            </div>
                      </a>
                        <a href="http://www.mokitouch.com/android/">
                            <div class="link topLeftRadius topRightRadius right filler">
                                <div class="space_link"></div>
                               <!--  <p>Custom Android <br /> tablet experience</p> -->
                            </div>
                        </a>
                        <a class="filler" href="http://www.mokitouch.com/ipad/">
                            <div class="link topLeftRadius topRightRadius right">
                                <div class="touch_link"></div>
                                <!-- <p>Customizable <br /> iPad Kiosk</p> -->
                            </div>
                        </a>
                        <div class="clear"></div>
                    </div>
