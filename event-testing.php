<?php
/*
Template Name: Event Testing Page
*/
?>

<?php get_header('test'); ?>

<link rel="stylesheet" href="<?php bloginfo('template_url'); ?>/style/responsive-test.css" type="text/css" xmlns="http://www.w3.org/1999/html"
